  ...
  zones: [
    {
      ...
      // Wall tiles line the top of the corridor; decorations appear along the walls
      wallsTop: ["tree_01", "tree_02", "tree_03", "tree_04"],
      wallsBottom: ["grass_01", "grass_02", "forest_rock_01", "forest_rock_02"],
      skyColor: ["#0d1f0d", "#1a2a1a"],
    ...
    },
    {
      ...
      wallsTop: ["cavern_wall_mid", "cavern_wall_top_left", "cavern_wall_top_right"],
      wallsBottom: ["cavern_stalagmite_01", "cavern_stalagmite_02"],
      skyColor: ["#0d0d1f", "#1a1a2a"],
    ...
    },
    {
      ...
      wallsTop: ["castle_wall_left_01", "castle_wall_left_02", "castle_sconce_left", "castle_wall_left_03"],
      wallsBottom: ["castle_column", "castle_column_02"],
      skyColor: ["#111111", "#2a2a2a"],
    ...
    },
    {
      ...
      wallsTop: ["cemetery_tree_01", "cemetery_tree_02", "cemetery_fence_col"],
      wallsBottom: ["cemetery_grave_01", "cemetery_grave_02"],
      skyColor: ["#0f0d1a", "#1f1a2a"],
    ...
    },
    {
      ...
      wallsTop: ["hell_spire_01", "hell_spire_02", "hell_torch"],
      wallsBottom: ["hell_bone_01", "hell_bone_02", "hell_column"],
      skyColor: ["#1a0505", "#2a1010"],
    ...
    },
    {
      ...
      wallsTop: ["cosmic_wall_01", "cosmic_wall_02", "cosmic_wall_03"],
      wallsBottom: ["cosmic_light_01", "cosmic_light_02"],
      skyColor: ["#050520", "#0a0a2a"],
